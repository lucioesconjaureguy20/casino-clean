              ...
              <div style={{ marginBottom: "4px" }}>
                ...
                <div style={{ ...rowStyle, alignItems: "flex-start" }}>
                  ...
                  <div style={{ width: btnW, flexShrink: 0 }}>
                    ...
                    <div style={{ fontSize: "11px", color: mutedText, lineHeight: 1.5, marginTop: "4px", whiteSpace: "nowrap" }}>Al activarlo, tu identidad aparecerá como Anónimo en el sitio.</div>
                  </div>
                </div>
              </div>
            </>
