...
export default function AffiliateProgram({ username, t, lang = "es", dashboardOnly, onRegister }: Props) {
  ...
  return (
    <section style={{ maxWidth: "1080px", margin: "0 auto", padding: isMobile ? "0 0 40px" : "0 20px 40px" }}>
        ...
        <div>
          ...
          <div style={{ display: "flex", flexDirection: isMobile ? "column" : "row", gap: "12px", marginBottom: "16px", alignItems: "stretch" }}>
            ...
            <div style={{
              ...
              <img
                src={assetUrl("/referral-banner.webp")}
                alt=""
                fetchPriority="high"
                decoding="async"
                style={{
                  ...
                  objectFit: "cover",
                  objectPosition: isMobile ? "84% center" : "left center",
                  pointerEvents: "none",
                }}
              />
              {/* Gradient overlay */}
            ...
            <div style={{
              ...
              <img
                src={assetUrl("/affiliate-bg.webp")}
                alt=""
                fetchPriority="high"
                decoding="async"
                style={{
          ...
          <div style={{ marginBottom: "20px" }}>
            ...
            <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(160px, 1fr))", gap: "10px" }}>
              {statCards.map(({ label, val, Icon, hint }, i) => {
                ...
                return (
                  <div key={i} style={{ ...statCardStyle, position: "relative", minHeight: "90px" }}>
                    {isFlipped ? (
                      <>
