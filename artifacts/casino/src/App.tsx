          ...
          {chatScreen === "chat" && !chatVerified && (
            <div style={{ flex:1, padding:"32px 24px", display:"flex", flexDirection:"column", gap:"16px", justifyContent:"center", animation:"chatScreenIn .25s ease-out" }}>
              <div style={{ textAlign:"center", marginBottom:"8px" }}>
                <img src="/mander-logo.png" alt="Mander" style={{ width:"210px", height:"210px", objectFit:"contain", display:"block", margin:"0 auto", marginBottom:"-138px", position:"relative", zIndex:0, top:"-60px", pointerEvents:"none" }} />
