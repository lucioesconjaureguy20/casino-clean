...
const LANGS: Record<string, Record<string, string>> = {
  ...
  de: {
    ...
    exploreRewards:"Belohnungen erkunden",
  ...
  fr: {
    ...
    exploreRewards:"Explorer les Récompenses",
  ...
  nl: {
    ...
    exploreRewards:"Beloningen verkennen",
  ...
  pl: {
    ...
    exploreRewards:"Przeglądaj Nagrody",
  ...
  tr: {
    ...
    exploreRewards:"Ödülleri Keşfet",
