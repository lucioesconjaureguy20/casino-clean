...
const LANGS: Record<string, Record<string, string>> = {
  ...
  id: {
    ...
    startAuto:"Mulai Otomatis", stopAuto:"Hentikan Otomatis",
  ...
  it: {
    ...
    startAuto:"Avvia Auto", stopAuto:"Ferma Auto",
  ...
  ko: {
    ...
    startAuto:"자동 시작", stopAuto:"자동 중지",
  ...
  ru: {
    ...
    startAuto:"Запустить авто", stopAuto:"Остановить авто",
  ...
  tr: {
    ...
    startAuto:"Otomatik Başlat", stopAuto:"Otomatik Durdur",
