            ...
            <li key={i} style={{ borderBottom:"1px solid #1a2235" }}>
              ...
              {item.key==="originals" && originalsMenuOpen && !sidebarCollapsed && (
                <ul className="casino-submenu" style={{ listStyle:"none",margin:0,padding:"4px 0 6px 0",background:"#0c1120",borderBottom:"1px solid #1a2235" }}>
                  {[
                    { icon:<svg viewBox="0 0 24 24" width="15" height="15" fill="none" stroke="currentColor" strokeWidth="1.6" strokeLinecap="round" strokeLinejoin="round"><rect x="2" y="2" width="20" height="20" rx="3"/><circle cx="8" cy="8" r="1.3" fill="currentColor" stroke="none"/><circle cx="16" cy="8" r="1.3" fill="currentColor" stroke="none"/><circle cx="12" cy="12" r="1.3" fill="currentColor" stroke="none"/><circle cx="8" cy="16" r="1.3" fill="currentColor" stroke="none"/><circle cx="16" cy="16" r="1.3" fill="currentColor" stroke="none"/></svg>, label:"Dados",     action:showDiceOnly,     view:"dice" },
                    { icon:<svg viewBox="0 0 24 24" width="15" height="15" fill="none" stroke="currentColor" strokeWidth="1.6" strokeLinecap="round" strokeLinejoin="round"><circle cx="12" cy="4.5" r="2.5"/><line x1="12" y1="7" x2="12" y2="10"/><line x1="7" y1="10" x2="17" y2="10"/><line x1="5" y1="15" x2="19" y2="15"/><line x1="3" y1="20" x2="21" y2="20"/><line x1="9" y1="10" x2="7" y2="15"/><line x1="15" y1="10" x2="17" y2="15"/></svg>, label:"Plinko",    action:showPlinkoOnly,   view:"plinko" },
                    { icon:<svg viewBox="0 0 24 24" width="15" height="15" fill="none" stroke="currentColor" strokeWidth="1.6" strokeLinecap="round" strokeLinejoin="round"><rect x="3" y="3" width="7" height="7" rx="1.5"/><rect x="14" y="3" width="7" height="7" rx="1.5"/><rect x="3" y="14" width="7" height="7" rx="1.5"/><rect x="14" y="14" width="7" height="7" rx="1.5"/></svg>, label:"Keno",      action:showKenoOnly,     view:"keno" },
                    { icon:<svg viewBox="0 0 24 24" width="15" height="15" fill="none" stroke="currentColor" strokeWidth="1.6" strokeLinecap="round" strokeLinejoin="round"><rect x="2" y="5" width="13" height="17" rx="2"/><rect x="9" y="2" width="13" height="17" rx="2"/></svg>, label:"Blackjack", action:showBlackjackOnly,view:"blackjack" },
                    { icon:<svg viewBox="0 0 24 24" width="15" height="15" fill="none" stroke="currentColor" strokeWidth="1.6" strokeLinecap="round" strokeLinejoin="round"><circle cx="12" cy="13" r="5"/><line x1="12" y1="8" x2="12" y2="5"/><line x1="7.5" y1="9.5" x2="5.5" y2="7.5"/><line x1="16.5" y1="9.5" x2="18.5" y2="7.5"/><line x1="7" y1="13" x2="4" y2="13"/><line x1="17" y1="13" x2="20" y2="13"/></svg>, label:"Mines",     action:showMinesOnly,    view:"mines" },
                    { icon:<svg viewBox="0 0 24 24" width="15" height="15" fill="none" stroke="currentColor" strokeWidth="1.6" strokeLinecap="round" strokeLinejoin="round"><rect x="2" y="4" width="12" height="16" rx="2"/><polyline points="18 4 21 7 18 10"/><polyline points="18 14 21 17 18 20"/><line x1="21" y1="7" x2="21" y2="17"/></svg>, label:"Hilo",      action:showHiloOnly,     view:"hilo" },
                    { icon:<svg viewBox="0 0 24 24" width="15" height="15" fill="none" stroke="currentColor" strokeWidth="1.6" strokeLinecap="round" strokeLinejoin="round"><circle cx="12" cy="12" r="10"/><circle cx="12" cy="12" r="3"/><line x1="12" y1="2" x2="12" y2="9"/><line x1="12" y1="15" x2="12" y2="22"/><line x1="2" y1="12" x2="9" y2="12"/><line x1="15" y1="12" x2="22" y2="12"/></svg>, label:"Ruleta",    action:showRouletteOnly, view:"roulette" },
                    { icon:<svg viewBox="0 0 24 24" width="15" height="15" fill="none" stroke="currentColor" strokeWidth="1.6" strokeLinecap="round" strokeLinejoin="round"><rect x="1" y="6" width="12" height="16" rx="2"/><rect x="11" y="2" width="12" height="16" rx="2"/></svg>, label:"Baccarat",  action:showBaccaratOnly, view:"baccarat" },
                  ].map((sub,si)=>{
