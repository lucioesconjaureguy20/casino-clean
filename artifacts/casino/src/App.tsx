...
const networkLimits: Record<string, Record<string, NetLimit>> = {
  ...
  LTC: {
    LTC:      { minDep:10,  maxDep:50000,  minWith:10,  maxWith:20000, wFee:0.5  }, // gas LTC ~$0.01-0.10
  },
};
  ...
  <circle cx="41" cy="42" r="1" strokeOpacity="0.5" strokeWidth="0.7"/>
        ...
        {section==="admin" && (
          <section style={{ animation:"nlsfadeIn 0.25s ease", minHeight:"calc(100vh - 70px)" }}>
            <AdminPanel token={supaSession?.access_token || localStorage.getItem(`mander_game_token_${currentUser}`) || ""} />
          </section>
        )}
      </main>
