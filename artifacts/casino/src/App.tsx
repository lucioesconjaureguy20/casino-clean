                    ...
                    <div style={{ display:"flex",alignItems:"stretch",gap:"12px" }}>
                      ...
                      <div style={{ flex:1,display:"flex",flexDirection:"column",justifyContent:"flex-end",gap:"8px" }}>
                        ...
                        <button onClick={()=>{ navigator.clipboard.writeText(pendingDeposit!.address!); setAddressCopied(true); setTimeout(()=>setAddressCopied(false),2000); }} className="cashier-btn"
                          style={{ width:"auto",alignSelf:"center",padding:"8px 28px",borderRadius:"7px",background:addressCopied?"#1a3a28":"#253548",border:`1px solid ${addressCopied?"#2a6a44":"#344d66"}`,color:addressCopied?"#4ade80":"#d4e0f0",fontWeight:600,fontSize:"13px",cursor:"pointer",display:"flex",alignItems:"center",justifyContent:"center",gap:"7px",transition:"background .2s,border-color .2s,color .2s" }}>
