...
export function RouletteRacetrack({ placeBet, tableBets, isSpinning, winNumber, lang = "es" }: Props) {
    ...
    <div style={{ width: "100%", userSelect: "none" }}>
      ...
      >
        <div style={{
          ...
          {/* Bottom row: 26 → 14 (reversed = right-to-left under top row) */}
      ...
      {hoverNum !== null && (
        <div style={{
          ...
          {gt(lang, "rtNeighborHint")} {getNeighbors(hoverNum, 2).join(" · ")}
        </div>
      )}
