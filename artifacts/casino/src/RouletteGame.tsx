      ...
      <div style={{ flex:1, minWidth:0, display:"flex", flexDirection:"column", gap:"16px", padding:"12px 16px 16px", background:"#0e1320" }}>
        ...
        {isMobile ? (
          ...
          <div style={{ display: isSpinning ? "none" : "block", padding:"0 6px" }}>
            <div style={{ display:"grid", gridTemplateColumns:"56px 56px 56px 56px 56px", gridTemplateRows:"28px repeat(12, 32px) 26px", gap:"0", width:"fit-content", margin:"0 auto" }}>
              ...
              {Array.from({length:36},(_,i)=>i+1).map(n => {
                ...
                return (
                  <div key={n} style={{ gridColumn:`${mCol}`, gridRow:`${mRow}` }}>
                    <NumCell num={n} cellH="32px" textStyle={{ writingMode:"vertical-rl" }} />
                  </div>
                );
              })}
