    ...
    <>
      ...
      <div style={{
        ...
        <div style={{
          ...
          {/* Left controls */}
          <button onClick={onBack} style={{width:"28px",height:"28px",background:"#1a2438",color:"#64748b",border:"1px solid #2a3550",borderRadius:"6px",cursor:"pointer",fontSize:"12px",display:"flex",alignItems:"center",justifyContent:"center",flexShrink:0}}>←</button>
