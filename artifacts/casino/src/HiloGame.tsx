  ...
  return (
    <div style={{ maxWidth:"1080px", margin:"0 auto", position:"relative", userSelect:"none", WebkitUserSelect:"none" }}>
      <div className="game-ctrl-grid" style={{
        ...
        minHeight:"714px", background:"#0e1320", borderRadius:"6px",
        ...
        <div className="game-ctrl-panel" style={{
          ...
          {(!isPlaying && (betNum <= 0 || !canBet)) ? (
            <div style={{ fontSize:"11.5px", color:"#e74c3c", fontWeight:600, marginBottom:"8px", paddingLeft:"2px" }}>
              {(balance <= 0.001 || (betNum > 0 && !canBet)) && <div>{T("insufficientBal")}</div>}
          ...
          {isIdle ? (
            <button
              ...
              style={{
                ...
                background: (betNum>0 && betUsdVal<=balance)
                  ? "linear-gradient(180deg,#1a9fff,#0d6fd4)"
                  : "#1a2438",
                color: (betNum>0 && betUsdVal<=balance) ? "#fff" : "#3a4a60",
                fontWeight:600, fontSize:"15px",
                cursor: (betNum>0 && betUsdVal<=balance) ? "pointer" : "not-allowed",
                boxShadow: (betNum>0 && betUsdVal<=balance) ? "0 4px 22px rgba(26,159,255,.35)" : "none",
                transition:"all .2s",
              }}
            >
          ...
          <div style={{
            ...
            <div style={{
              ...
              <div style={{
                ...
                <div style={{ fontSize: isMobile ? "10px" : "11px", fontWeight:600, color:"#5a7090", marginBottom:"8px", wordBreak:"break-word", lineHeight:1.3 }}>
                ...
                <div style={{
                  ...
                  <span style={{
                    flex:1, fontSize: isMobile ? "15px" : "18px", fontWeight:600,
