    ...
    <div style={{ maxWidth:"1080px", margin:"0 auto", position:"relative", userSelect:"none", WebkitUserSelect:"none" }}>
      <div style={{
        ...
        <div style={{
          ...
          <div style={{ fontWeight:500, fontSize:"15px", letterSpacing:"1.5px", color:"#fff", display:"flex", alignItems:"center", gap:"8px" }}><svg viewBox="0 0 24 24" width="18" height="18" fill="none" stroke="currentColor" strokeWidth="1.7" strokeLinecap="round" strokeLinejoin="round"><polyline points="8 5 12 2 16 5"/><polyline points="8 19 12 22 16 19"/><path d="M4 9v6M20 9v6M4 12h4M16 12h4"/><rect x="8" y="8" width="8" height="8" rx="1"/></svg>HILO</div>
          ...
          <div>
            <div style={{ display:"flex", justifyContent:"space-between", alignItems:"center", marginBottom:"7px" }}>
              ...
              <span style={{ color:"#5a6a88", fontSize:"12px", ...dMStyle }}>
                {potentialPayout > 0 ? `${convertUsd(potentialPayout).toFixed(currRate >= 10000 ? 0 : 2)} ${displayCurrency}` : `0,00 ${displayCurrency}`}
              </span>
            </div>
            <div style={{
              ...
              <input
                readOnly
                value={potentialPayout > 0 ? convertUsd(potentialPayout).toFixed(currRate >= 10000 ? 0 : 2) : "0.00"}
                style={{
                  flex:1, background:"transparent", border:"none",
              ...
              <div style={{
                ...
                <div style={{
                  ...
                  <span style={{
                    ...
                    {isPlaying ? fmtMoney(betNum * accMult * higherMult) : fmtMoney(0)}
                  </span>
                </div>
              </div>
              {/* Menor */}
              <div style={{
                ...
                <div style={{
                  ...
                  <span style={{
                    ...
                    {isPlaying ? fmtMoney(betNum * accMult * lowerMult) : fmtMoney(0)}
                  </span>
                </div>
              </div>
            </div>
